...
public class CloudConnector : MonoBehaviour
{
	...
	private string webServiceUrl = "https://script.google.com/macros/s/AKfycbyalXny_AHZswddJLuHgvBRXaitZCMBTKHHgIF5bezL4Kgl-Ps/exec";
	private string spreadsheetId = "1HmrtAQSSPNya5qns2xBObX5ByL8AcEW4rqcOgR72Tf4"; // If this is a fixed value could also be setup on the webservice to save POST request size.
	private string servicePassword = "tumblebundle";
